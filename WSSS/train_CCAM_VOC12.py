...
from tools.ai.paddle_utils import *
...
if __name__ == '__main__':
    ...
    model_path = model_dir + '{}.pdparams'.format(args.tag)
    ...
    optimizer = paddle.optimizer.Adam(
        parameters=[
            {'params': param_groups[0], 'learning_rate': args.lr, 'weight_decay': args.wd},
            {'params': param_groups[1], 'learning_rate': 2 * args.lr, 'weight_decay': 0},
            {'params': param_groups[2], 'learning_rate': 10 * args.lr, 'weight_decay': args.wd},
            {'params': param_groups[3], 'learning_rate': 20 * args.lr, 'weight_decay': 0},
        ],
    ...
    for epoch in range(args.max_epoch):
        ...
        #################################################################################################
        # save_model_fn()
        paddle.save({'state_dict': model.state_dict(), 'flag': flag}, model_path)
