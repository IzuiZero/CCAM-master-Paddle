...
class ImageNetDataset(data.Dataset):
    ...
    def __init__(self, root, pseudo_bboxes_path, gt_path, input_size=256, crop_size=224, train=True, transform=None,
        ...
        if self.train:
            ...
            self.bbox_dict = load_val_bbox(self.img_dataset, self.gt_path)

        self.img_dataset = self.img_dataset
...
if __name__ == '__main__':
    ...
    train_loader = data.DataLoader(dataset=MyTrainData,
                                   batch_size=1,
                                   shuffle=True, num_workers=0, use_shared_memory=True)
